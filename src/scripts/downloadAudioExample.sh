...
youtube-dl -f bestaudio --extract-audio --audio-format mp3 --audio-quality 256K 'https://www.youtube.com/watch?v=HawbJ76Xg1Y'
...
ffmpeg -i The\ Blue\ Whale-yjamrOtMKfE.webm -b:a 256K -map a the-blue-whale.mp3
